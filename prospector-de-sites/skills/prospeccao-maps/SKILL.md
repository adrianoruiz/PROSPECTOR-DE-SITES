...
**E-MAIL É OBRIGATÓRIO (BRASIL).** A proposta vai por e-mail — lead brasileiro sem e-mail público não fecha o ciclo. Procure nesta ordem: site (rodapé e página de contato), links `mailto:`, home do site da clínica onde atende, busca no Google por "[nome] + email/contato". Se NÃO encontrar e-mail: **descarte o lead, registre na lista de descartados (com o contato que existir, ex. WhatsApp/Instagram) e continue buscando o próximo** até bater a meta. Atenção: "site" que aponta para diretório de terceiros (localtreino, acheioprofissional etc.) não conta como site próprio — descarta pelo Filtro 2.

**EUA — contato é mais escondido.** Negócio americano quase nunca expõe e-mail: o padrão é formulário de contato no próprio site, e muito contato acontece via Facebook/Instagram. Por isso, no lead US, capriche na busca antes de desistir: site (rodapé e página "Contact"), links `mailto:`, perfil de Facebook e Instagram do negócio e, como fallback, o formulário de contato. Anote em `obs` qual meio existe (ex.: "sem e-mail público; contato via formulário do site" ou "melhor canal: Instagram @..."). Só descarte um lead americano se NÃO houver nenhum canal viável — havendo formulário ou rede social, ele segue qualificado (a abordagem final se adapta ao canal).
